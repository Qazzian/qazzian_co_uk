 ...
 * IN a way this is more about documenting the page attributes then providing much functionality.
 * It does give each page a unique id.
 */
...
Page.prototype = {
	...
	*/
	...
	templatePath: '',
	/* String, content from the mustache template */
	template:'',
	/* The fully rendered page built by Mustache */
	html:'',
